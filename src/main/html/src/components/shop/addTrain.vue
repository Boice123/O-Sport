<template>
  <div class="addtrainContainer">
    <div class="addtrainknow">新增户外培训活动</div>
...
import { API_uploadFileURL, API_saveTrainURL } from '../../constants/index.js'
import $ from 'jquery'
            ...
            axios({
              ...
              .then((response) => {
                ...
                if(response.data.code == 0) {
                  ...
                  this.$message.error('添加报团户外培训信息失败，请稍后重试');
                }
            })
              .catch((err) => {
                console.log(err)
